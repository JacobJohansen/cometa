...
class GeneratePDF(View):
    ...
    def SendEmail(self):
        ...
        email = EmailMultiAlternatives(
            ...
            headers={'X-COMETA': 'proudly_generated_by_cometa', 'X-COMETA-SERVER': COPYRIGHT, 'X-COMETA-VERSION': str(version), 'X-COMETA-FEATURE': self.feature.feature_name, 'X-COMETA-DEPARTMENT':self.feature.department_name}
        )
